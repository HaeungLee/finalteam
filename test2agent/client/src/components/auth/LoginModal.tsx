        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-green-500 text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500"
            >
              <span className="w-5 h-5 mr-2 bg-white text-green-500 rounded text-sm font-bold flex items-center justify-center">
                N
              </span>
              네이버로 계속하기
            </button>
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-yellow-400 text-gray-900 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500"
            >
              <span className="w-5 h-5 mr-2 bg-gray-900 text-yellow-400 rounded text-sm font-bold flex items-center justify-center">
                K
              </span>
              카카오로 계속하기
            </button>
